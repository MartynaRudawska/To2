...
namespace GeneticSharp.Domain.Crossovers
{
    ...
    /// </summary>
    public abstract class MyCrossoverBase : IMyCrossover
    {
        #region Constructors
        /// <summary>
        ...
        protected MyCrossoverBase(int parentsNumber, int childrenNumber) : this(parentsNumber, childrenNumber, 2)
        {
        ...
        protected MyCrossoverBase(int parentsNumber, int childrenNumber, int minChromosomeLength)
        {
            ParentsNumber = parentsNumber;
            ChildrenNumber = childrenNumber;

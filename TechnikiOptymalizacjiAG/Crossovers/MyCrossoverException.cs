...
namespace GeneticSharp.Domain.Crossovers
{
	...
	/// </summary>
	[Serializable]
    public sealed class MyCrossoverException : Exception
    {
        #region Constructors        
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneticSharp.Domain.Crossovers.MyCrossoverException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MyCrossoverException"/> class.
        /// </summary>
        public MyCrossoverException()
        {
        }
        ...
        public MyCrossoverException(string message)
            : base(message)
        {
        }
        ...
        public MyCrossoverException(string message, Exception innerException)
        ...
        private MyCrossoverException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        #endregion

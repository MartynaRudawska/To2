...
namespace GeneticSharp.Domain.Selections
{
	...
	/// </summary>
	[DisplayName("Turniej")]
    public class MyTournamentSelection : MySelectionBase
    {
        #region Constructors
        /// <summary>
        ...
        /// </remarks>
        /// </summary>
        public MyTournamentSelection() : this(2)
        {
        }
        ...
        public MyTournamentSelection(int size) : this(size, true)
        {
        }
        ...
        public MyTournamentSelection(int size, bool allowWinnerCompeteNextTournament) : base(2)
        {
            Size = size;
        ...
        protected override IList<IChromosome> PerformSelectChromosomes(int number, Generation generation)
        {
            ...
            {
                throw new MySelectionException(
                    this,
                    "Rozmiar turnieju jest większy niż ilość dostępnych chromosomów. Rozmiar turnieju to {0}  generacji  {1} a dostępnych chromosomów jest {2}.".With(Size, generation.Number, generation.Chromosomes.Count));
            }

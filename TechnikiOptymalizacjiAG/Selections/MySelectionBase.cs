...
namespace GeneticSharp.Domain.Selections
{
    ...
    /// </summary>
    public abstract class MySelectionBase : MyISelection
    {
        #region Fields
        ...
        public IList<IChromosome> SelectChromosomes(int number, Generation generation)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("Iloœæ chromosomów", "Iloœæ wybranych chromosomów powinna wynosiæ co najmniej {0}.".With(m_minNumberChromosomes));
            }

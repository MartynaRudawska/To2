...
namespace GeneticSharp.Domain.Selections
{
    ...
    /// </summary>
    [DisplayName("Ruletka")]
    public class MyRouletteWheelSelection : MySelectionBase
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneticSharp.Domain.Selections.MyRouletteWheelSelection"/> class.
        /// </summary>
        public MyRouletteWheelSelection() : base(2)
        {
        }
        #endregion
